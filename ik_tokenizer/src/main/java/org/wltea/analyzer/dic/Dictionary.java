...
public class Dictionary {
	...
	private void loadMainDict(){
		...
		//读取主词典文件
		// 当前类(class)所在的包目录
		System.out.println(Dictionary.class.getResource("/org/wltea/analyzer/dic/main2012.dic"));
		// class path根目录
		System.out.println(Dictionary.class.getResource("/"));

		String fileName = Dictionary.class.getResource("/") + "/org/wltea/analyzer/dic/main2012.dic";
